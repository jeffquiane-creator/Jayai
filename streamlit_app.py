# app.py — Funnel Pilot Hub (clean build)
# Features:
# - Top radio nav (Agent Objections | Brokerage Comparison | Favorites)
# - Searchable, paginated radio lists (show ALL objections/brokerages)
# - Browser Text-to-Speech ▶️ buttons with global Rate, Pitch, Volume
# - Copy buttons for Rebuttal / One-Liner / SMS / Power Statement
# - Favorites add/remove + export (Excel)
# - Upload/Export datasets (xlsx/csv)
# - Works with: Agent_Objections_Rebuttals.xlsx, Top_25_Brokerage_Rebuttals_Final_with_Power_Statements.xlsx
